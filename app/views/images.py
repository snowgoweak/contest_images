...
from app.models.api import ResolutionImagesModel
...
async def create_file(file: UploadFile = File(None), url: str = Body(None)):
    if file:
...
async def resize_image(img_id: int, res: ResolutionImagesModel):
